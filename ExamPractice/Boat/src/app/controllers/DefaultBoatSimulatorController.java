...
import app.enumerations.EngineType;
import app.exeptions.*;
import app.models.DefaultBoatRace;
import app.models.boat_engines.BaseBoatEngine;
import app.models.boat_engines.JetEngine;
import app.models.boat_engines.SterndriveEngine;
import app.models.boats.*;
...
public class DefaultBoatSimulatorController implements BoatSimulatorController {
    ...
    public String createBoatEngine(String model, int horsepower, int displacement, String engineType)
            throws DuplicateModelException, IncorrectPropertyValueException, IncorrectModelLengthException {
    ...
    public String createPowerBoat(String model, int weight, String firstEngineModel, String secondEngineModel)
            throws NonExistantModelException, DuplicateModelException, IncorrectPropertyValueException, IncorrectModelLengthException {
    ...
    public String openRace(int distance, int windSpeed, int oceanCurrentSpeed, Boolean allowsMotorboats)
            throws RaceAlreadyExistsException, IncorrectPropertyValueException {
